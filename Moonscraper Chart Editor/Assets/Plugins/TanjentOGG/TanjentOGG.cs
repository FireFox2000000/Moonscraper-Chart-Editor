...
namespace TanjentOGG
{
    public class TanjentOGG
    {
        ...
        private Ogg.ogg_sync_state oy; /* sync and verify incoming physical bitstream */
        private Ogg.ogg_stream_state os; /* take physical pages, weld into a logical stream of packets */
        private Ogg.ogg_page og; /* one Ogg bitstream page. Vorbis packets are inside */
        private Ogg.ogg_packet op; /* one raw packet of data for decode */
        ...
        public TanjentOGG()
        {
            ...
            os = new Ogg.ogg_stream_state(); /* take physical pages, weld into a logical stream of packets */
            og = new Ogg.ogg_page(); /* one Ogg bitstream page. Vorbis packets are inside */
            op = new Ogg.ogg_packet(); /* one raw packet of data for decode */
        ...
        public void DecodeToFloats(byte[] fileBytes)
        {
            ...
            this.DecodedFloats = new float[0];
            int totalSamples = 0;
            ...
            this.DecodedFloats = new float[totalSamples];
            int lastSize = 0;
