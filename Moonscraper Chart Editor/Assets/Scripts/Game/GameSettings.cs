...
public class GameSettings
{
    ...
    public bool GetBoolSetting(string identifier)
    {
        switch (identifier)
        {
            ...
            case ("openTapChordsEnabled"): return openTapChordsEnabled;
    ...
    public GameSettings()
    {
        ...
        openTapChordsEnabled = new BoolSaveSetting(SECTION_NAME_SETTINGS, "Open Chords & Tap Opens", false);
