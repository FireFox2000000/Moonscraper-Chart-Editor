...
{
    [AddComponentMenu("UI/CustomDropdown", 35)]
    [RequireComponent(typeof(RectTransform))]
    public class CustomUnityDropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
    {
        ...
        public void Show()
        {
            ...
            // Fade in the popup
            //AlphaFadeList(m_FadeSpeed, 0f, 1f);
        ...
        private void InstantDestroyDropdownList()
        {
            for (int i = 0; i < m_Items.Count; i++)
            {
                if (m_Items[i] != null)
